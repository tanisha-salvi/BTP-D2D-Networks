...
class NrSlPdcpSapProvider
{
  public:
    ...
    struct NrSlTransmitPdcpSduParameters
    {
         ...
         */
        NrSlTransmitPdcpSduParameters(Ptr<Packet> pdcpSdu,
                                      uint16_t rnti,
                                      uint8_t lcId,
                                      uint8_t sduType)
        {
...
class NrSlPdcpSapUser
{
  public:
    ...
    struct NrSlReceivePdcpSduParameters
    {
         ...
         */
        NrSlReceivePdcpSduParameters(Ptr<Packet> pdcpSdu,
                                     uint16_t rnti,
                                     uint8_t lcId,
                                     uint32_t srcL2Id,
                                     uint32_t dstL2Id,
...
template <class C>
void
MemberNrSlPdcpSapProvider<C>::TransmitNrSlPdcpSdu(const NrSlTransmitPdcpSduParameters& params)
{
...
template <class C>
void
MemberNrSlPdcpSapUser<C>::ReceiveNrSlPdcpSdu(const NrSlReceivePdcpSduParameters& params)
{
